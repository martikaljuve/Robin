...
namespace Rihma.FindGolfBalls
{
	public partial class Window : Form
	{
		...
		public Window()
		{
			...
			const string filename = @"C:\Temp\Rihma-01.jpg";
		...
		public void FindChessboard(Image<Bgr, byte> img, Image<Gray, byte> gray) {
			var patternSize = new Size(5, 8);
			PointF[] corners;
			var patternFound = CameraCalibration.FindChessboardCorners(
				gray,
				patternSize,
				CALIB_CB_TYPE.ADAPTIVE_THRESH | CALIB_CB_TYPE.NORMALIZE_IMAGE | CALIB_CB_TYPE.FILTER_QUADS,
				out corners);
