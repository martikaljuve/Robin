...
Pid pidLeft = Pid(0.8, 0.2, 0.001);
Pid pidRight = Pid(0.8, 0.2, 0.001);
Pid pidBack = Pid(0.8, 0.2, 0.001);
...
Wheels wheels = Wheels(motorLeft, motorRight, motorBack, pidLeft, pidRight, pidBack);
