...
#define set_high(portdir,pin) set_input(portdir,pin)  // pordi pin pööratakse 0-ks - ehk input
#define set_low(portdir,pin) set_output(portdir,pin) // pordi pin pööratakse 1-ks - ehk output
